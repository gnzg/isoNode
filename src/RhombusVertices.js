...
export default function ({tile, y, x}) {
  ...
  this.mapX = state.env.mapX;
  this.mapY = state.env.mapY;

  // leftmost point
  this.pointA = {
    x: tile.tileWidth * y + this.mapX + tile.tileWidth * x,
    y: tile.d + tile.topYsegment
  };
  // central bottom point
  this.pointB = {
    x: tile.tileWidth * y + this.mapX + tile.tileWidth * x + tile.tileWidth,
    y: tile.topYsegment + tile.tileWidth * 2
  };
  // rightmost point
  this.pointC = {
    x: tile.tileWidth * y + this.mapX + tile.tileWidth * x + tile.tileWidth * 2,
    y: tile.d + tile.topYsegment
  };
  // central top point
  this.pointD = {
